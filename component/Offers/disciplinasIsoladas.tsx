export default function OfferDisciplinaIsolada() {
    return (
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-8">
                    ...
                    <div className="flex-1 text-center md:text-right">
                        ...
                        <div className="text-white mb-1">
                            <span className="fontKrona text-2xl md:text-3xl">Bolsas de até</span>
                            <br />
                            <span className="fontKrona text-4xl md:text-6xl font-bold">+50%</span>
